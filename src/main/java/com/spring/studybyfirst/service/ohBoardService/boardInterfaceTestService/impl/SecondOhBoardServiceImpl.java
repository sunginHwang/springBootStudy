...
@Service
public class SecondOhBoardServiceImpl implements OhBoardServiceTest {

    @Autowired
    private ReactBoardDbMapper reactBoardDbMapper;

    @Override
    public List<IBoard> getBoardListTest() throws Exception{
        return reactBoardDbMapper.getIBoardListNotTitle();
    }
}
